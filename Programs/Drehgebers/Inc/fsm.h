 ...
 *          Definiert den Aufzählungstyp Direction (IDLE, FORWARD, BACKWARD,
 * ERRO) und deklariert Funktionen zur Richtungsbestimmung anhand von
 *          Phasenübergängen sowie zur Reinitialisierung aller
 * Zustandsvariablen.
 ******************************************************************************
 */
/* Includes ------------------------------------------------------------------*/
