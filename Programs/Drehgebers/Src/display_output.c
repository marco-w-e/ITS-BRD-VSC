 ...
 * @date    03.05.2026
 * @brief   Ausgabe von Winkel und Drehzahl auf einem LCD-Display.
 *          Stellt ein zweizeiliges Layout bereit (Zeile 2: Winkel in Grad,
 *          Zeile 4: Geschwindigkeit) und gibt die formatierten Werte
 *          zeichenweise über eine nicht-blockierende State-Machine aus.
 ******************************************************************************
 */
/* Includes ------------------------------------------------------------------*/
#include "lcd.h"
